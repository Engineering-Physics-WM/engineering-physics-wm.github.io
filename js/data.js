const announcements2026 = [
  ...
  },
  {
    ...
    order: 2,
    date: "2026-05-13",
    label: "Wed · May 13 · 5 PM",
    title: "Ranking poll closes.",
    summary: "Students can edit their saved response until 5:00 PM.",
    body: [
      "The poll closes Wednesday, May 13 at 5:00 PM. To change a response before then, return to the ranking poll, use the same W&M email, and submit the revised order.",
    ],
    audience: "All students",
    pinned: false,
    resources: [
