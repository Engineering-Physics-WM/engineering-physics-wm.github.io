const announcements2026 = [
  {
    ...
    summary:
      "The project preference poll is closed and kept here as a record of the matching stage.",
    body: [
  ...
  },
  {
    ...
    body: ["The ranking poll closed on Wednesday, May 13 at 4:00 PM."],
    audience: "All students",
    pinned: false,
    resources: [{ label: "Ranking poll", kind: "Site", page: "ranking" }],
  },
  {
    id: "team-preview",
    cohortYear: "2026-2027",
    ...
    summary:
      "Final teams are ready to announce; students should watch W&M email for assignments and course registration guidance.",
    body: [
  ...
  },
  {
    ...
    summary:
      "Honors students should plan for EPAD 495, EPAD 496, and an advisor-department honors research course across the academic year.",
    body: [
...
const EP_DATA = {
  ...
  projects: [
    ...
    },
    {
      ...
      title:
        "Modification of a high-speed, electric, unmanned surface vessel (USV) race boat towards full-stack agentic control.",
      advisor: "Jonathan Frey",
      affiliation: "Applied Science",
      advisorEmail: "jfrey@wm.edu",
      coadvisors: null,
      areas: [
        "AI-driven measurement or analysis",
        "Robotics / autonomy / controls",
        "Public-facing / installation / outreach",
        "Instrumentation / sensors",
      ],
      pitch:
        "William & Mary Racing is moving to improve the mechanical systems of the unmanned race boat to achieve higher average speeds as well as modifying the autonomous control systems and sensors to achieve full stack agentic AI control of the vessel.",
      background:
    ...
    },
    {
      ...
      advisor: "Ran Yang",
      affiliation: "Physics",
      advisorEmail: "rxyan2@wm.edu",
      coadvisors: [
        { name: "Gunter Luepke", affiliation: "Applied Science", email: "gxluep@wm.edu" },
      ],
      areas: [
        "Instrumentation / sensors",
        "AI-driven measurement or analysis",
    ...
    },
    {
      ...
      advisor: "Benjamin D. Whiting",
      affiliation: "Music",
      advisorEmail: "bdwhiting@wm.edu",
      coadvisors: [
  ...
  announcementAudiences: [
    { id: "all", label: "All students + active mentors" },
    { id: "students", label: "All students" },
    { id: "honors_students", label: "Honors students" },
    { id: "mentors", label: "All active mentors" },
  ...
  archive: [
    {
      ...
      students: 8,
      summary:
        "Archive details for this cohort are being organized and will be expanded as records are cleaned up.",
      status: "past",
    },
    {
      year: "2026-2027",
      title: "Current cohort — you are here",
      projects: 9,
      teams: 6,
      students: 18,
      summary:
    ...
    },
    {
      ...
      students: null,
      summary:
        "Placeholder for next year. Ranking and team data will land here once the cohort starts.",
      status: "future",
    },
  ],
  ...
  cohorts: {
    "2025-2026": {
      ...
      placeholderSummary:
        "The app is prepared for the 2025-2026 project slate, public updates, final teams, and dashboard records. Add the real public materials when they are ready.",
      cohortStatus: {
        label: "Archive prep",
    ...
    "2027-2028": {
      ...
      placeholderSummary:
        "The app is prepared for the next project slate, ranking poll, public updates, and dashboard records. Add proposals and roster data when that cycle opens.",
      cohortStatus: {
        label: "Reserved",
        activeLabel: "Active team",
        inactiveLabel: "Inactive this year",
...
const announcementKey = (item) =>
  `${item.cohortYear || ""}:${item.slug || item.id || item.title || ""}`;
...
const resolveCohortData = (data = EP_DATA, selectedYear = data.currentYear) => {
  ...
  return {
    ...
    placeholderTitle:
      cohort.placeholderTitle || archiveItem?.title || "Cohort materials coming soon.",
    placeholderSummary:
      cohort.placeholderSummary ||
      archiveItem?.summary ||
